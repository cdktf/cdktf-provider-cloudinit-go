...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudinit.CloudinitProviderConfig",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudinit.ConfigConfig",
		reflect.TypeOf((*ConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudinit.ConfigPart",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudinit.DataCloudinitConfigConfig",
		reflect.TypeOf((*DataCloudinitConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-cloudinit.DataCloudinitConfigPart",
